...
import { AudioList } from './Mobilelist';

export const AudioPage = ({searchQuery}) => {

  console.log(searchQuery,AudioList, "**********");
          ...
          <div key={index} className="col">
            <Carousel>
              ...
              <div className="card-body">
                      ...
                      <Link to={`/audio/${item.name.toLowerCase().replace(/\s+/g, '-')}/description`} className="btn btn-primary">
                        more info
                      </Link>
                  </div>
          </div>
