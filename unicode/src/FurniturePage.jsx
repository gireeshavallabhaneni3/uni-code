...
import { FurnitureList } from './Mobilelist';

export const FurniturePage = ({searchQuery}) => {

  console.log(searchQuery,FurnitureList, "**********");
          ...
          <div key={index} className="col">
            <Carousel>
              ...
              <div className="card-body">
                      ...
                      <Link to={`/furniture/${item.name.toLowerCase().replace(/\s+/g, '-')}/description`} className="btn btn-primary">
                        more info
                      </Link>
                  </div>
          </div>
